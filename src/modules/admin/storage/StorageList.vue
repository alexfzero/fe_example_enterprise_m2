  ...
  <div>
    ...
    <v-container class="d-flex flex-column justify-center align-center">
      ...
      <ApplyDialog
          ...
          :get-text="() => `Вы уверены, что хотите удалить данную позицию ?`"
...
import StorageEditForm from "@/modules/admin/storage/StorageEditForm.vue";
...
export default {
  ...
  data() {
    return {
      ...
      count: 0,
      options: {},
      URL: urls.API + roles.SUPER_ADMIN + urls.REFERENCES.NAME + urls.REFERENCES.PATH.STORAGES,
      loadingPage: false,
      attrs: undefined,
      ...
      headers: [
        ...
        {text: 'Номер', value: 'product_number', align: 'start', sortable: false},
        {text: 'Наименование', value: 'product_name', align: 'start', sortable: true},
        {text: 'Артикул', value: 'product_article', align: 'start', sortable: true},
  ...
  methods: {
    ...
    closeDeleteDialog(event) {
      ...
      if (event) {
        let id_url = this.product_data.id + '/'
