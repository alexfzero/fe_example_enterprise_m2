  ...
  <div>
    ...
    <v-container class="d-flex flex-column justify-center align-center">
      ...
      <ApplyDialog
          ...
          :get-text="() => `Вы уверены, что хотите удалить данную должность ?`"
...
import PosDialog from "@/modules/admin/positions/PosEditForm.vue";
  ...
  data() {
    return {
      ...
      headers: [
        ...
        {text: 'Департамент', value: 'department.text', align: 'start', sortable: false},
        {text: 'Начальник', value: 'is_head', align: 'center', sortable: false, width: '25px'},
